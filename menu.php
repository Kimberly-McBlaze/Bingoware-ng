	...
	<applet code="fphover.class" codebase="./" width="120" height="20">
		...
		<param name="url" valuetype="ref" value="index.php?action=generate<?= (isset($_GET["numberinplay"]))?'&numberinplay='.$_GET["numberinplay"]:''; ?>">
		<param name="hoverimage" valuetype="ref" value="images/b1d.gif">
		<param name="color" value="#ffffff">
	</applet><br><br>
	<applet code="fphover.class" codebase="./" width="120" height="20">
		<param name="image" valuetype="ref" value="images/b3u.gif">
		<param name="url" valuetype="ref" value="index.php?action=view<?= (isset($_GET["numberinplay"]))?'&numberinplay='.$_GET["numberinplay"]:''; ?>">
		<param name="hoverimage" valuetype="ref" value="images/b3d.gif">
	</applet><br><br>
	<applet code="fphover.class" codebase="./" width="120" height="20">
		<param name="image" valuetype="ref" value="images/b2u.gif">
		<param name="url" valuetype="ref" value="index.php?action=play<?= (isset($_GET["numberinplay"]))?'&numberinplay='.$_GET["numberinplay"]:''; ?>">
		<param name="hoverimage" valuetype="ref" value="images/b2d.gif">
	</applet><br><br>
	<applet code="fphover.class" codebase="./" width="120" height="20">
		<param name="image" valuetype="ref" value="images/b4u.gif">
		<param name="url" valuetype="ref" value="index.php?action=config<?= (isset($_GET["numberinplay"]))?'&numberinplay='.$_GET["numberinplay"]:''; ?>">
