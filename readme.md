...
---
## 🗂️ Known Issues
- Themes are broken. Dark mode not properly going dark and themes seem to reset to default when switching between dark and light modes. Themes don't properly apply throughout the app.
